...
def get_media_insights(media_id, access_token, story ):
    metrics = ("views","reach", "replies","shares","likes","navigation","profile_activity") if story else metrics = ("views","reach","likes","comments","saved","shares","total_interactions","profile_activity","follows","caption","timestamp")    
    if not access_token:
